...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">STAFF DASHBOARD <sup></sup></div>
    </a>
        ...
        <div class="card">
            ...
            <div class="card-body" id="profileDetails"> <!-- Add an ID to this div for JavaScript -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="staffUsername" value="<?php echo $staff['username']; ?>" disabled>
                </div>
                <div class="form-group">
