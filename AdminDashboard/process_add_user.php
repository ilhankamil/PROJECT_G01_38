...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['phonenumber']) && isset($_POST['userType'])) {
        ...
        // Validate and sanitize user inputs before binding parameters
        // Example: $username = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
        // You should apply similar validation and sanitization to other inputs
        ...
        if ($stmt->execute()) {
            ...
            $stmt = $pdo->prepare("UPDATE user SET verified_email = 'verified', verification_code = '000000' WHERE id = :id");
